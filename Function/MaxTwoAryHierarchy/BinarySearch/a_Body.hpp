...
template <typename U , typename V , typename INT , typename FUNC> inline MaxTwoAryHierarchyBinarySearch<U,V,INT,FUNC>::MaxTwoAryHierarchyBinarySearch( FUNC func , const INT& x_min , const INT& x_max , const U& dummy1 , const V& dummy2 ) : VirtualMaxTwoAryHierarchy<U,V,INT,FUNC>( move( func ) , x_min , x_max , dummy1 , dummy2 ) , TwoAryHierarchyBinarySearchIntersection<U,V,INT,FUNC>( this->m_func , this->m_x_min , this->m_x_max ) {}
template <typename U , typename V , typename INT , typename FUNC> inline MinTwoAryHierarchyBinarySearch<U,V,INT,FUNC>::MinTwoAryHierarchyBinarySearch( FUNC func , const INT& x_min , const INT& x_max , const U& dummy1 , const V& dummy2 ) : VirtualMinTwoAryHierarchy<U,V,INT,FUNC>( move( func ) , x_min , x_max , dummy1 , dummy2 ) , TwoAryHierarchyBinarySearchIntersection<Reversed<U>,Reversed<V>,INT,ReversedTwoAryHierarchy<U,V,INT,FUNC>>( this->m_func , this->m_x_min , this->m_x_max ) {}
