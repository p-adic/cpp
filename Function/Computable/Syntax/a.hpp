...
DECLARATION_OF_GLOBAL_CONSTANT_STRING_FOR_SYMBOL( Nat );
DECLARATION_OF_GLOBAL_CONSTANT_STRING_FOR_SYMBOL( Omega );
...
DECLARATION_OF_GLOBAL_CONSTANT_STRING_FOR_SYMBOL( ForAll );
