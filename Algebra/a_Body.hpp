...
template <typename U , typename F_U> inline AbstractNSet<U,F_U>& AbstractNSet<U,F_U>::operator=( const AbstractNSet<U,F_U>& ) noexcept { return *this; }
...
template <typename U , typename M_U> inline AbstractMagma<U,M_U>& AbstractMagma<U,M_U>::operator=( const AbstractMagma<U,M_U>& ) noexcept { return *this; }
