...
template <class Traits , typename Arg1 , typename Arg2> inline basic_istream<char,Traits>& operator>>( basic_istream<char,Traits>& is , pair<Arg1,Arg2>& arg );
...
template <class Traits> inline basic_ostream<char,Traits>& operator<<( basic_ostream<char,Traits>& os , const type_info& type ) noexcept;
