...
template <typename T0> string to_string_Normalised( const T0& t0 ) noexcept;
template <typename T0 , typename T1 , typename... T2> string to_string_Normalised( const T0& t0 , const T1& t1 , const T2&... t2 ) noexcept;

template <typename T> void echo( const T& ) noexcept;
