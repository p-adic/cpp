// c:/Users/user/Documents/Programming/Utility/LinkedVector/Entry/a_Body.hpp
...
template <typename T> inline EntryOfLinkedVector<T>::EntryOfLinkedVector( EntryOfLinkedVector<T>&& e ) : m_t() , m_prev_entry( 0 ) , m_next_entry( 0 ) {}
