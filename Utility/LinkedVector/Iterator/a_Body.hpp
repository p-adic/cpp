// c:/Users/user/Documents/Programming/Utility/LinkedVector/Iterator/a_Body.hpp
...
template <typename T> inline IteratorOfLinkedVector<T>::IteratorOfLinkedVector( LinkedVector<T>* const& p ) noexcept : m_p( p ) , m_i( i ) {}
template <typename T> inline IteratorOfLinkedVector<T>::IteratorOfLinkedVector( const IteratorOfLinkedVector<T>& itr ) noexcept : m_p( itr.m_p ) , m_i( itr.m_1 ) {}
...
template <typename T> inline void IteratorOfLinkedVector<T>::operator++( int ) { m_i = ( *m_p )[m_i].m_next_entry; }
template <typename T> inline void IteratorOfLinkedVector<T>::operator--( int ) { m_i = ( *m_p )[m_i].m_prev_entry; }
...
template <typename T> inline ConstIteratorOfLinkedVector<T>::ConstIteratorOfLinkedVector( const LinkedVector<T>* const& p ) noexcept : m_p( p ) , m_i( i ) {}
template <typename T> inline ConstIteratorOfLinkedVector<T>::ConstIteratorOfLinkedVector( const ConstIteratorOfLinkedVector<T>& itr ) noexcept : m_p( itr.m_p ) , m_i( i ) {}
template <typename T> inline ConstIteratorOfLinkedVector<T>::ConstIteratorOfLinkedVector( const IteratorOfLinkedVector<T>& itr ) noexcept : m_p( itr.m_p ) , m_i( i ) {}
...
template <typename T> inline void ConstIteratorOfLinkedVector<T>::operator++( int ) { m_i = ( *m_p )[m_i].m_next_entry; }
template <typename T> inline void ConstIteratorOfLinkedVector<T>::operator--( int ) { m_i = ( *m_p )[m_i].m_prev_entry; }
