// c:/Users/user/Documents/Programming/Utility/Set/IntervalScheduling/a_Body.hpp
...
template <typename T> inline void IntervalScheduling<T>::SetNext( vector<int>& a ) const noexcept
{
...
template <typename T> inline void IntervalScheduling<T>::SetMaximal( list<int>& a , const int& i ) const
{
