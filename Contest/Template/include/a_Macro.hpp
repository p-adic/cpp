...
#pragma once
  ...
  #define DERR( ... ) VariadicCout( ofs_err , __VA_ARGS__ ) << endl
  ...
  #define DERRNS( ... ) CERRNS( __VA_ARGS__ )
#endif
...
#define REPEAT_MAIN( BOUND )                                    \
  ...
  #define FINISH_MAIN                                                     \
      ...
      REPEAT( sample_repetition_num ){                                  \
        ...
        DERRNS( "サンプル" , stoi( sample_num ) , "を実行します。\n" ); \
        DERR( "" );                                                     \
        ...
        DERRNS( "サンプル" , stoi( sample_num ) , "の実行を終了しました。" ); \
        DERR( "" );                                                     \
      }                                                                 \
    }                                                                 \
