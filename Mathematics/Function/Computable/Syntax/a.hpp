...
DECLARATION_OF_GLOBAL_CONSTANT_STRING_FOR_SYMBOL( NestedArray );
...
// expression
DECLARATION_OF_GLOBAL_CONSTANT_STRING_FOR_SYMBOL( True );
DECLARATION_OF_GLOBAL_CONSTANT_STRING_FOR_SYMBOL( False );
