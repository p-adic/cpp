...
template <typename VArg, typename... Args> inline VariadicRelationSymbol<VArg, Args...>::VariadicRelationSymbol( const string& r , const SeparatorOfComputableFunction& s , const TypeNameOfComputableFunction& type_name , const VariableSymbol<Args>&... args ) : RelationSymbol<Args...,void>( r , s , type_name , args... , LdotsSymbol<VArg>() ) {}
