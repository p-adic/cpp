...
#define DEFINITION_OF_VARIADIC_FUNCTION_SYMBOL_APPLICATION_MORE( RET , FUNC , SYMB ) \
									\
  DECLARATION_OF_VARIADIC_FUNCTION_SYMBOL_APPLICATION_MORE( RET , FUNC ){ return CONNECT( FUNC , SYMB )()( e1 , e2 , args... ); } \
									\
