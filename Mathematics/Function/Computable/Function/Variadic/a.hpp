...
DECLARATION_OF_VARIADIC_FUNCTION_SYMBOL_APPLICATION_TWO( int , Plus );
DECLARATION_OF_VARIADIC_FUNCTION_SYMBOL_APPLICATION_TWO( string , Plus );
DECLARATION_OF_VARIADIC_FUNCTION_SYMBOL_APPLICATION_TWO( bool , Plus );
...
DECLARATION_OF_VARIADIC_FUNCTION_SYMBOL_APPLICATION_TWO( int , Times );
DECLARATION_OF_VARIADIC_FUNCTION_SYMBOL_APPLICATION_TWO( bool , Times );
