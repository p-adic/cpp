...
template <typename Ret, typename VArg, typename... Args> inline VariadicFunctionSymbol<Ret,VArg,Args...>::VariadicFunctionSymbol( const string& f , const TypeNameOfComputableFunction& type_name , const VariableSymbol<Args>&... args ) : VariadicFunctionSymbol( f , SeparatorOfComputableFunction( f , sizeof...( Args ) , true ) , type_name , args... ) {}

template <typename Ret, typename VArg, typename... Args> inline VariadicFunctionSymbol<Ret,VArg,Args...>::VariadicFunctionSymbol( const string& f , const SeparatorOfComputableFunction& s , const TypeNameOfComputableFunction& type_name , const VariableSymbol<Args>&... args ) : FunctionSymbol<Ret,Args...,void>( f , s , type_name , args... , LdotsSymbol<VArg>() ) {}
