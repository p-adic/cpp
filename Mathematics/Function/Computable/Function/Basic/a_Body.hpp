...
// チェーン表記
inline const VariadicFunctionSymbol<int,int,int>& ChainSymbol() noexcept { static const VariadicFunctionSymbol<int,int,int> f{ ToString() , SeparatorOfComputableFunction( 0 , EmptyString() , SpaceString() + ToString() + SupString() , LdotsString() , SpaceString() + ToString() + SupString() , EmptyString() ) , VariableSymbol<int>( "a" ) }; return f; }
...
// N原始
inline const VariadicFunctionSymbol<string,int,string>& NPrimitiveSymbol_Body_1() noexcept { static const VariadicFunctionSymbol<string,int,string> f{ to_string( "N_1" ) , SeparatorOfComputableFunction( 0 , to_string( Plainise( "N" ) ) , LbrackString() , LdotsString() , CommaString() , RbrackString() ) , VariableSymbol<string>( "version" ) }; return f; }

inline const FunctionSymbol<int,string,int>& NPrimitiveSymbol_Body_2() noexcept { static const FunctionSymbol<int,string,int> f{ to_string( "N_2" ) , SeparatorOfComputableFunction( 0 , EmptyString() , LparenString() , RparenString() ) , VariableSymbol<string>( "NvA" ) , VariableSymbol<int>( "a" ) }; return f; }
