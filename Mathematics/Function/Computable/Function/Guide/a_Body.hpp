...
template <typename Ret> template <typename VArg, typename... Args> inline auto FunctionSymbol_Guide<Ret>::Get( const string& name , const TypeNameOfComputableFunction& type_name , const VariableSymbol<Args>&... args , const VariadicVariableSymbol<VArg> ldots ) -> typename enable_if<! is_same<Ret,bool>::value && disjunction<is_base_of<VariableSymbol<void>,Args>...>::value ,VariadicFunctionSymbol<Ret,VArg,Args...> >::type { return VariadicFunctionSymbol<Ret,VArg,Args...>( name , type_name , args... ); }
  
template <typename... Args> inline auto FunctionSymbol_Guide<bool>::Get( const string& name , const TypeNameOfComputableFunction& type_name , const VariableSymbol<Args>&... args ) -> typename enable_if<! disjunction<is_base_of<VariableSymbol<void>,Args>...>::value,RelationSymbol<Args...> >::type { return RelationSymbol<Args...>( name , type_name , args... ); }

template <typename VArg, typename... Args> inline auto FunctionSymbol_Guide<bool>::Get( const string& name , const TypeNameOfComputableFunction& type_name , const VariableSymbol<Args>&... args , const VariadicVariableSymbol<VArg> ldots ) -> typename enable_if<disjunction<is_base_of<VariableSymbol<void>,Args>...>::value ,VariadicRelationSymbol<VArg,Args...> >::type { return VariadicRelationSymbol<VArg,Args...>( name , type_name , args... ); }
