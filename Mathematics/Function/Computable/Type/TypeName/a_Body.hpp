...
template <typename T> inline auto GetName() -> typename enable_if<is_base_of<TypeOfComputableFunction,T>::value,const string&>::type { return T::GetName(); }
...
template <typename T> inline auto GetSyntax() -> typename enable_if<is_base_of<TypeOfComputableFunction,T>::value,const SyntaxOfComputableFunction&>::type { return T::GetSyntax(); }
