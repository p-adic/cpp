...
#define DEFINITION_OF_DUMMY_CLASS( CLASS_NAME )				\
									\
  static const CLASS_NAME CONNECT( CONNECT( __DEFINITION_OF_ , CLASS_NAME ) , __ ){}; \
  static const CLASS_NAME & CONNECT( CONNECT( __SYMBOL_OF_ , CLASS_NAME ) , __ ) = CONNECT( CONNECT( __DEFINITION_OF_ , CLASS_NAME ) , __ ); \
									\
