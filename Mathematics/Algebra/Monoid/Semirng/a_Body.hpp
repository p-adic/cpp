...
template <typename U , typename MONOID , typename SEMIGROUP> inline U AbstractSemirng<U,MONOID,SEMIGROUP>::Sum( const U& u0 , const U& u1 ) { return m_R0.Sum( u0 , u1 ); }
...
template <typename U , typename MONOID , typename SEMIGROUP> inline U AbstractSemirng<U,MONOID,SEMIGROUP>::Product( const U& u0 , const U& u1 ) { return m_R1.Product( u0 , u1 ); }
