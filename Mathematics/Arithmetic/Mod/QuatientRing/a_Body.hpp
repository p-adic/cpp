// c:/Users/user/Documents/Programming/Mathematics/Arithmetic/Mod/QuatientRing/a_Body.hpp

#pragma once
#include "a.hpp"

template <typename INT> inline QuotientRing<INT>::QuotientRing() noexcept : m_n() , m_p_M( nullptr ) {}
template <typename INT> inline QuotientRing<INT>::QuotientRing( const INT& n , const INT* const & p_M ) noexcept : m_n( n ) , m_p_M( p_M ) {}
