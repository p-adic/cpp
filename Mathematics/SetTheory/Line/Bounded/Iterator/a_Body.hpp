...
template <typename INT , template <typename...> typename DATA_STR> inline IteratorOfBoundedLineSubset<INT,DATA_STR>::IteratorOfBoundedLineSubset( AbstractBoundedLineSubset<INT,DATA_STR>& S , INT i ) : m_p( &S ) , m_i( move( i ) ) {}
