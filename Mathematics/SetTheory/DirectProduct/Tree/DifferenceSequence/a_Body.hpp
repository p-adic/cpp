// c:/Users/user/Documents/Programming/Mathematics/SetTheory/DirectProduct/Tree/DifferenceSequence/a_Body.hpp
...
template <typename V , list<V> E(const V&) , V E_inv(const V&) , V enum_V(const int&) , int enum_V_inv(const V&) , typename T , T& m_T(const T&,T&) , const T& e_T() , typename U , U inv_U(const U&) , T& o_U(const U&,T&) , int size_max> inline EnumerationDifferenceSequence<V,E,E_inv,enum_V,enum_V_inv,T,m_T,e_T,U,inv_U,o_U,size_max>::EnumerationDifferenceSequence( const int& size ) :
...
template <typename V , list<V> E(const V&) , V E_inv(const V&) , V enum_V(const int&) , int enum_V_inv(const V&) , typename T , T& m_T(const T&,T&) , const T& e_T() , typename U , U inv_U(const U&) , T& o_U(const U&,T&) , int size_max> inline list<V> EnumerationDifferenceSequence<V,E,E_inv,enum_V,enum_V_inv,T,m_T,e_T,U,inv_U,o_U,size_max>::Edge( const V& v ) const { return E( v ); }
...
template <typename V , list<V> E(const V&) , V E_inv(const V&) , V enum_V(const int&) , int enum_V_inv(const V&) , typename T , T& m_T(const T&,T&) , const T& e_T() , typename U , U inv_U(const U&) , T& o_U(const U&,T&) , int size_max> inline V EnumerationDifferenceSequence<V,E,E_inv,enum_V,enum_V_inv,T,m_T,e_T,U,inv_U,o_U,size_max>::Edge_inv( const V& v ) const { return E_inv( v ); }
...
template <typename V , list<V> E(const V&) , V E_inv(const V&) , V enum_V(const int&) , int enum_V_inv(const V&) , typename T , T& m_T(const T&,T&) , const T& e_T() , typename U , U inv_U(const U&) , T& o_U(const U&,T&) , int size_max> inline int EnumerationDifferenceSequence<V,E,E_inv,enum_V,enum_V_inv,T,m_T,e_T,U,inv_U,o_U,size_max>::e_inv( const V& v ) const { return enum_V_inv( v ); }

template <typename T , int size_max> inline const T& DifferenceSequence<T,size_max>::Unit() const { static const T unit{}; return unit; }
template <typename V , list<V> E(const V&) , V E_inv(const V&) , V enum_V(const int&) , int enum_V_inv(const V&) , typename T , T& m_T(const T&,T&) , const T& e_T() , typename U , U inv_U(const U&) , T& o_U(const U&,T&) , int size_max> inline const T& EnumerationDifferenceSequence<V,E,E_inv,enum_V,enum_V_inv,T,m_T,e_T,U,inv_U,o_U,size_max>::Unit() const { return e_T(); }

template <typename T , int size_max> inline T& DifferenceSequence<T,size_max>::Addition( const T& t0 , T& t1 ) const { return t1 += t0; }
template <typename V , list<V> E(const V&) , V E_inv(const V&) , V enum_V(const int&) , int enum_V_inv(const V&) , typename T , T& m_T(const T&,T&) , const T& e_T() , typename U , U inv_U(const U&) , T& o_U(const U&,T&) , int size_max> inline T& EnumerationDifferenceSequence<V,E,E_inv,enum_V,enum_V_inv,T,m_T,e_T,U,inv_U,o_U,size_max>::Addition( const T& t0 , T& t1 ) const { return m_T( t0 , t1 ); }

template <typename T , int size_max> inline T DifferenceSequence<T,size_max>::Inverse( const T& u ) const { return -u; }
template <typename V , list<V> E(const V&) , V E_inv(const V&) , V enum_V(const int&) , int enum_V_inv(const V&) , typename T , T& m_T(const T&,T&) , const T& e_T() , typename U , U inv_U(const U&) , T& o_U(const U&,T&) , int size_max> inline U EnumerationDifferenceSequence<V,E,E_inv,enum_V,enum_V_inv,T,m_T,e_T,U,inv_U,o_U,size_max>::Inverse( const U& u ) const { return inv_U( u ); }
