...
template <typename U , typename ABELIAN_GROUP> template <typename...Args> inline void AbstractHybridBIT<U,ABELIAN_GROUP>::Initialise( Args&&... args ) { *this = AbstractHybridBIT<U,ABELIAN_GROUP>( move( this->m_M ) , forward<Args>( args )... ); }
