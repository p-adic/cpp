// c:/Users/user/Documents/Programming/Mathematics/SetTheory/DirectProduct/AffineSpace/BIT/Template/MonoidBIT/a_Body.hpp

#pragma once
#include "a.hpp"

template <TEMPLETE_ARGUMENTS_FOR_MONOID_BIT> inline const T& AbstractBIT<T,m_T,e_T,N>::g_e = e_T();

template <TEMPLETE_ARGUMENTS_FOR_MONOID_BIT> inline MonoidBIT<T,m_T,e_T,N>::MonoidBIT() : m_a() , m_fenwick_0() , m_fenwick_1()
{
...
template <TEMPLETE_ARGUMENTS_FOR_MONOID_BIT> inline MonoidBIT<T,m_T,e_T,N>::MonoidBIT( const T ( &a )[N] ) : m_init( n ) , m_a() , m_fenwick_0() , m_fenwick_1() 
{
...
template <TEMPLETE_ARGUMENTS_FOR_MONOID_BIT> inline const T& MonoidBIT<T,m_T,e_T,N>::operator[]( const int& i ) const { return m_a[i]; } 
template <TEMPLETE_ARGUMENTS_FOR_MONOID_BIT> inline const T& MonoidBIT<T,m_T,e_T,N>::Get( const int& i ) const { return m_a[i]; } 
