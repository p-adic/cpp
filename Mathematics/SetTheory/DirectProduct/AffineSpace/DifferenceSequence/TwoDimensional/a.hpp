...
public:
  inline AbstractTwoDimensionalDifferenceSequence( GROUP M , const int& size_X , const int& size_Y , int degree = 1 );
  inline AbstractTwoDimensionalDifferenceSequence( GROUP M , const vector<vector<U>>& a = {} , int degree = 0 );
