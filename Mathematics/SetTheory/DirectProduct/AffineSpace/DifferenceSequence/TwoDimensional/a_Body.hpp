...
template <typename U , typename GROUP> inline void AbstractTwoDimensionalDifferenceSequence<U,GROUP>::Set( vector<vector<U>> a ) { *this = AbstractTwoDimensionalDifferenceSequence<U,GROUP>( move( m_M ) , move( a ) ); }
