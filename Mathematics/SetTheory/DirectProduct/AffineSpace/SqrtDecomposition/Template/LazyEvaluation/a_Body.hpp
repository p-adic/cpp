...
template <TEMPLATE_ARGUMENTS_FOR_LAZY_SQRT_DECOMPOSITION> inline constexpr void LazySqrtDecomposition<T,m_T,e_T,U,m_U,e_U,o_U,N,N_sqrt>::IntervalAct_Body( const int& d , T& t ) { const int i_min = d * N_sqrt; IntervalAct_Body( i_min , i_min + N_sqrt , t ); t = g_e_T; }
