...
public:
  ...
  inline constexpr void IntervalSet( const int& i_start , const int& i_final , const T& u );
...
private:
  inline constexpr void IntervalProd_Body( const int& i_min , const int& i_ulim ) const;

  inline constexpr void SetProd( const int& i );
  inline constexpr void SolveSuspension( const int& d , const u& );
  inline constexpr void IntervalSet_Body( const int& i_min , const int& i_ulim , const T& t );
