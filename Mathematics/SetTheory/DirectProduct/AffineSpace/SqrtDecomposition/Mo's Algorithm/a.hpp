// c:/Users/user/Documents/Programming/Mathematics/SetTheory/DirectProduct/AffineSpace/SqrtDecomposition/Mo's Algorithm/a.hpp
...
public:
  ...
  // Mo's Algorithmで各クエリ(x,y)に対するf(x,y)を計算。
