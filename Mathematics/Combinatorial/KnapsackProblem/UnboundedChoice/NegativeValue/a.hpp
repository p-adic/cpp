...
template <typename INT1 , typename INT2> inline vector<INT1> NegativeValueUnboundedChoiceMulticaseKnapsack( const vector<INT1>& value , const INT1& exceptional , const vector<INT2>& cost , const INT2& cost_sum_bound );
// 計算量O(N + cost_sum_bound^2)で
// 各iに対し項目iを無制限に重複選択できるとして、
