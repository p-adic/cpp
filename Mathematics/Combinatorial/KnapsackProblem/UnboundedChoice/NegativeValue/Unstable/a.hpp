...
// verify:
// NegativeValueUnboundedChoiceCostwiseUnstableKnapsack（CS,cost_sum_bound）
...
template <typename INT1 , typename VALUE , typename INT2 , typename COST , typename INT3> inline vector<INT1> NegativeValueUnboundedChoiceUnstableCostwiseKnapsack( VALUE value , const INT1& exceptional , COST cost , const INT2& cost_sum_bound , const vector<INT3>& choice_stability_num );
// 計算量O(CS * cost_sum_bound)で
