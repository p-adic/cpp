...
// AbstractNegativeValueUnboundedChoiceMulticaseUnstableDependentKnapsackÇ…égÇ§ÅB
#include "../a_Body.hpp"
...
template <typename U , typename N_MODULE , typename VALUE1 , typename VALUE2 , typename INT1 , typename COST1 , typename COST2 , typename INT2 , typename INT3 , typename INT4> inline vector<U> AbstractNegativeValueUnboundedChoiceMulticaseUnstableDependentKnapsack( N_MODULE M , VALUE1 value1 , VALUE2 value2 , const U& exceptional , COST1 cost1 , COST2 cost2 , const INT1& cost_sum_bound , vector<INT2>& choice_stability_num1 , const vector<INT2>& choice_stability_num2 , const vector<INT3>& dependence , const vector<INT4>& init , const vector<INT4>& diff ) { auto [value,cost] = GetDependentItemData( M , move( value1 ) , move( value2 ) , move( cost1 ) , move( cost2 ) , choice_stability_num1 , choice_stability_num2 , dependence , init , diff ); return AbstractNegativeValueUnboundedChoiceMulticaseUnstableKnapsack( move( M ) , move( value ) , exceptional , move( cost ) , cost_sum_bound , choice_stability_num1 ); }
template <typename INT1 , typename VALUE1 , typename VALUE2 , typename INT2 , typename COST1 , typename COST2 , typename INT3, typename INT4 , typename INT5> inline vector<INT1> NegativeValueUnboundedChoiceMulticaseUnstableDependentKnapsack( VALUE1 value1 , VALUE2 value2 , const INT1& exceptional , COST1 cost1 , COST2 cost2 , const INT2& cost_sum_bound , vector<INT3>& choice_stability_num1 , const vector<INT3>& choice_stability_num2 , const vector<INT4>& dependence , const vector<INT5>& init , const vector<INT5>& diff ) { return AbstractNegativeValueUnboundedChoiceMulticaseUnstableDependentKnapsack( Module<ll,ret_t<VALUE1,int,ll>>() , move( value1 ) , move( value2 ) , exceptional , move( cost1 ) , move( cost2 ) , cost_sum_bound , choice_stability_num1 , choice_stability_num2 , dependence , init , diff ); }
template <typename U , typename N_MODULE , typename VALUE1 , typename VALUE2 , typename INT1 , typename COST1 , typename COST2 , typename INT2 , typename INT3 , typename INT4> inline pair<U,INT1> AbstractNegativeValueUnboundedChoiceUnstableDependentKnapsack( N_MODULE M , VALUE1 value1 , VALUE2 value2 , const U& exceptional , COST1 cost1 , COST2 cost2 , const INT1& cost_sum_bound , vector<INT2>& choice_stability_num1 , const vector<INT2>& choice_stability_num2 , const vector<INT3>& dependence , const vector<INT4>& init , const vector<INT4>& diff ) { pair<U,INT1> answer = { M.One() , 0 }; auto value_max = AbstractNegativeValueUnboundedChoiceMulticaseUnstableDependentKnapsack( move( M ) , move( value1 ) , move( value2 ) , exceptional , move( cost1 ) , move( cost2 ) , cost_sum_bound , choice_stability_num1 , choice_stability_num2 , dependence , init , diff ); for( INT1 c = 0 ; c <= cost_sum_bound ; c++ ){ auto& v_c = value_max[c]; v_c != exceptional && answer.first < v_c ? answer = { move( v_c ) , c } : answer; } return answer; }
