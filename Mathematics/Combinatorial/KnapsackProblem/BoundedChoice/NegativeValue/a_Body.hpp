...
// AbstractBoundedChoiceNegativeValueCostwiseKnapsackÇ…égÇ§ÅB
#include "../a_Body.pp"
#include "../../Negative/Value/a_Body.pp"

template <typename U , typename N_MODULE , typename INT1 , typename INT2> inline vector<U> AbstractNegativeValueBoundedChoiceCostwiseKnapsack( N_MODULE M , const vector<U>& value , const U& exceptional , const vector<INT1>& cost , const INT1& cost_sum_bound , const vector<INT2>& choice_num_bound ) { vector<U> value_new; vector<INT1> cost_new; SetIteratedItem( M , Module<int,INT1>() , N , value , value_new , cost , cost_new , choice_num_bound ); return AbstractNegativeValueCostwiseKnapsack( move( M ) , value_new , exceptional , cost_new , cost_sum_bound ); }
template <typename INT1 , typename INT2 , typename INT3> inline vector<INT1> NegativeValueBoundedChoiceCostwiseKnapsack( const vector<INT1>& value , const INT1& exceptional , const vector<INT1>& cost , const INT2& cost_sum_bound , const vector<INT3>& choice_num_bound ) { return AbstractNegativeValueBoundedChoiceCostwiseKnapsack( AdditiveGroup<INT1>() , value , exceptional , cost , cost_sum_bound , choice_num_bound ); }
