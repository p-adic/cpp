...
template <typename U , typename N_MODULE , typename INT1 , typename INT2> inline vector<U> AbstractNegativeValueBoundedChoiceMulticaseKnapsack( N_MODULE M , const vector<U>& value , const U& exceptional , const vector<INT1>& cost , const INT1& cost_sum_bound , const vector<INT2>& choice_num_bound );
template <typename INT1 , typename INT2 , typename INT3> inline vector<INT1> NegativeValueBoundedChoiceMulticaseKnapsack( const vector<INT1>& value , const INT1& exceptional , const vector<INT1>& cost , const INT2& cost_sum_bound , const vector<INT3>& choice_num_bound );
