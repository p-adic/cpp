...
template <typename INT1 , typename INT2> inline vector<bool> BoundedChoiceCostfreeConstructibilityBoundedValueSumKnapsack( const vector<INT1>& value , const INT1& value_sum_bound , const vector<INT2>& choice_num_bound );
...
template <typename INT1 , typename INT2> inline INT1 BoundedChoiceCostfreeBoundedValueSumKnapsack( const vector<INT1>& value , const INT1& value_bound , const INT1& value_sum_bound , const vector<INT2>& choice_num_bound );
