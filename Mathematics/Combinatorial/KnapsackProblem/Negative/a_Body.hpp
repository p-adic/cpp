...
pair<U1,U2> AbstractNegativeKnapsack( COMM_MONOID1 M1 , COMM_MONOID2 M2 , const vector<U1>& value , const U1& value_sum_ubound , const vector<U2>& cost , const U2& cost_sum_lbound , const U2& cost_sum_ubound )
{
...
template <typename INT1 , typename INT2> inline pair<INT1,INT2> NegativeKnapsack( const vector<INT1>& value , const INT1& value_sum_ubound , const vector<INT2>& cost , const INT2& cost_sum_lbound , const INT2& cost_sum_ubound ) { return AbstractNegativeKnapsack( AdditiveMonoid<INT1>() , AdditiveMonoid<INT2>() , value , value_sum_ubound , cost , cost_sum_lbound , cost_sum_ubound ); }
