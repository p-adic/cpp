...
template <typename INT1 , typename INT2> inline vector<INT1> NegativeValueMulticaseKnapsack( const vector<INT1>& value , const INT1& exceptional , const vector<INT2>& cost , const INT2& cost_sum_bound );
