...
inline list<int> LinearEdge::operator()( const int& t ) { list<int> answer{}; if( m_directed && t > 0 ){ answer.push_back( t - 1 ); } if( t + 1 < m_size ){ answer.push_back( t + 1 ); } return answer; }
